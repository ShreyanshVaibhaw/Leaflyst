...
export default function SecurityPage() {
  return <>
    <PageHeader eyebrow="Trust center" title="Security and responsible disclosure" description="How AgentBlackBox protects recorded agent activity and how to report a vulnerability." />
